...
# TODO This "be" needs to be changed
# TODO get it from response_data
# TODO do it as icons data
# TODO rgb
...
def getWeather(window):
    city = textField.get()
    api_response_url = "https://api.openweathermap.org/data/2.5/weather?q=" + \
        city + "&appid=" + APPID
...
# textflied added
textField = tk.Entry(window, bg='#fafafa', justify='center',
                     font=('poppins', 35, 'italic'), width=20)
...
icons_label = tk.Label(window, bg='#ffafaf')
